<x-app-layout>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 space-y-4">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h3 class="text-lg font-semibold">Trainer Attendance</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-300">
                                Scan the trainer QR code twice per day — once to check in and once to check out.
                            </p>
                        </div>
                        <span
                            id="status-pill"
                    ...
                    <div class="p-6 space-y-6 text-gray-900 dark:text-gray-100">
                        <div id="camera-panel" class="space-y-4">
                            <div class="space-y-1">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-300">
                                    Point the camera at the trainer QR code shown at the front desk.
                                </p>
                            </div>
    ...
    <script>
            ...
            if (trimmed.startsWith('http')) {
                try {
                    ...
                    if (type && type !== 'trainer') {
                        return { error: 'This QR link is not for trainers.' };
                    }
        ...
        const recordScan = async (token) => {
            ...
            scanUrl.searchParams.set('type', 'trainer');
